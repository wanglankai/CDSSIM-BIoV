...
BlockNum = [50,75,100,125,150,175]
uninstalltimes3080 = [0]*len(BlockNum)
for a in range(len(BlockNum)):
    ...
    for b in range(BlockNum[a]):
        ...
        delStorage(0.3,0.8)
    uninstalltimes3080[a] = sumtime

print(uninstalltimes3080)

uninstalltimes3070 = [0]*len(BlockNum)
for a in range(len(BlockNum)):
    num = 40
    encourage = [0]*num
    AllC = [100] * num
    ...
    for b in range(BlockNum[a]):
        ...
        for i in range(len(findRSUID)):
            AllC[findRSUID[i]] = AllC[findRSUID[i]] - 5
        delStorage(0.3,0.7)
    uninstalltimes3070[a] = sumtime
print(uninstalltimes3070)
uninstalltimes4080 = [0]*len(BlockNum)
for a in range(len(BlockNum)):
    num = 40
    encourage = [0]*num
    AllC = [100] * num
    ...
    for b in range(BlockNum[a]):
        ...
        for i in range(len(findRSUID)):
            AllC[findRSUID[i]] = AllC[findRSUID[i]] - 5
        delStorage(0.4,0.8)
    uninstalltimes4080[a] = sumtime
print(uninstalltimes4080)
uninstalltimes4070 = [0]*len(BlockNum)
for a in range(len(BlockNum)):
    num = 40
    encourage = [0]*num
    AllC = [100] * num
    ...
    for b in range(BlockNum[a]):
        ...
        for i in range(len(findRSUID)):
            AllC[findRSUID[i]] = AllC[findRSUID[i]] - 5
        delStorage(0.4,0.7)
    uninstalltimes4070[a] = sumtime
print(uninstalltimes4070)
uninstalltimes3090 = [0]*len(BlockNum)
for a in range(len(BlockNum)):
    num = 40
    encourage = [0]*num
    AllC = [100] * num
    ...
    for b in range(BlockNum[a]):
        ...
        for i in range(len(findRSUID)):
            AllC[findRSUID[i]] = AllC[findRSUID[i]] - 5
        delStorage(0.3,0.9)
    uninstalltimes3090[a] = sumtime
print(uninstalltimes3090)
uninstalltimes4090 = [0]*len(BlockNum)
for a in range(len(BlockNum)):
    num = 40
    encourage = [0]*num
    AllC = [100] * num
    ...
    for b in range(BlockNum[a]):
        ...
        for i in range(len(findRSUID)):
            AllC[findRSUID[i]] = AllC[findRSUID[i]] - 5
        delStorage(0.4,0.9)
    uninstalltimes4090[a] = sumtime
print(uninstalltimes4090)
